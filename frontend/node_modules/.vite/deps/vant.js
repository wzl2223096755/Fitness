...
var stdin_default20 = defineComponent({
  ...
  setup(props2, {
    ...
    const setCurrentIndexByName = (name210, skipScrollIntoView) => {
      const index = children.findIndex((tab, index2) => getTabName(tab, index2) === name210);
...
var popupInheritKeys2 = [...popupSharedPropKeys, "transition", "closeOnPopstate", "destroyOnClose"];
...
var stdin_default69 = defineComponent({
  ...
  setup(props2, {
    ...
    const updateState = () => {
      ...
      state.value = {
        x: offset2 ? offset2.x : windowWidth.value - width2 - gapX.value,
        y: offset2 ? offset2.y : windowHeight.value - height2 - gapY.value,
        width: width2,
        height: height2
      };
    };
  ...
  setup(props2, {
    ...
    const onTouchend = () => {
      ...
      if (props2.magnetic) {
        ...
        height2.value = Math.max(min, Math.min(max, height2.value));
      }
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "ref": contentRef,
        "style": {
          paddingBottom: addUnit(boundary.value.max - height2.value)
        }
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)])]);
    };
  }
